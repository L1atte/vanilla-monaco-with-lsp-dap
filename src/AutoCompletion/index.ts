...
import { SQLCore } from "../SQLCore";
import { CodeCompletionCore } from "antlr4-c3/out";
import { AutocompleteOption } from "../Model/AutocompleteOption";
import { AutocompleteOptionType } from "../Model/AutocompleteOptionType";
import { SimpleSQLTokenizer } from "../Model/SimpleSQLTokenizer";
...
export class SQLAutocomplete {
  ...
  constructor(dialect: SQLDialect, tableNames?: string[], columnNames?: string[]) {
    ...
    this.antlr4tssql = new SQLCore(this.dialect);
