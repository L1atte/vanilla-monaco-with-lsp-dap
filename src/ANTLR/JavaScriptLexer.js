...
JavaScriptLexer.Literal = 10;
JavaScriptLexer.Number = 11;
JavaScriptLexer.String = 12;
JavaScriptLexer.Identifier = 13;
JavaScriptLexer.Whitespace = 14;
// tslint:disable:no-trailing-whitespace
JavaScriptLexer.channelNames = ["DEFAULT_TOKEN_CHANNEL", "HIDDEN"];
// tslint:disable:no-trailing-whitespace
JavaScriptLexer.modeNames = ["DEFAULT_MODE"];
JavaScriptLexer.ruleNames = ["T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "T__7", "T__8", "Literal", "Number", "String", "Identifier", "Whitespace"];
JavaScriptLexer._LITERAL_NAMES = [undefined, "'var'", "'='", "';'", "'function'", "'('", "')'", "','", "'{'", "'}'"];
...
JavaScriptLexer.VOCABULARY = new VocabularyImpl(JavaScriptLexer._LITERAL_NAMES, JavaScriptLexer._SYMBOLIC_NAMES, []);
JavaScriptLexer._serializedATN =
